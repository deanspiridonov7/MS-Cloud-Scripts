...
$appfolder = new-item -Path ".\apps" -Name "WebRTC_RedirectorService" -ItemType Directory -Force
$downloadsource = 'https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RWQ1UW'
$filename = "WebRTCRedirectorService.MSI"
...
$logoURL = "https://logos-world.net/wp-content/uploads/2020/09/Microsoft-Logo-700x394.png"
$LogoFileName = "MS.png"
...
$Displayname = "WebRTC_RedirectorService"
$Description = "WebRTC_RedirectorService for Teams on AVD"
